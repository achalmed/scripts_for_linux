"""
app/main_window.py — Ventana principal de Git Studio.
...
from app.controllers.repos_controller import ReposController
...
class MainWindow:
    ...
    def __init__(self, settings: SettingsService):
        ...
        self._workers: list = []
        self.context = AppContext(self.settings, ConfigService(),
                                  self.history, self)
        ...
        pages = [
            ...
            ("repos", "Repositorios", "repos", ReposController),
            ("sync", "Sincronizar", "sync", SyncController),
            ("clone", "Clonar", "clone", CloneController),
    ...
    def _about(self) -> None:
        QMessageBox.about(
            self.ui, "Acerca de Git Studio",
            f"<b>Git Studio</b> v{APP_VERSION}<br><br>"
            "Administración unificada de repositorios Git:<br>"
            "clonado desde GitHub, sincronización pull→commit→push, "
            "estado y reportes.<br><br>"
